<x-modal-panel show="showEdit" :require-selected="true">
    ...
    <template x-if="selected">
        <form method="POST" :action="`{{ url('/dashboard/products') }}/${selected.id}`" enctype="multipart/form-data" class="space-y-4">
            ...
            <label class="block border-2 border-dashed border-gray-700 rounded-lg h-48 flex items-center justify-center text-gray-500 text-sm cursor-pointer hover:border-cyan-400 relative overflow-hidden">
