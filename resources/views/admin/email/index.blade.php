        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 px-4 sm:px-8 py-8">
                ...
                <div
                    ...
                    x-data="emailSearch('{{ route('admin.email.search') }}')">
                        ...
                        <form method="POST" action="{{ route('admin.email.send') }}">
                            ...
                            <div class="mb-6 relative">
                                ...
                                <div class="relative">
                                    ...
                                    <svg
                                        class="w-5 h-5 absolute right-4 top-1/2 -translate-y-1/2 text-zinc-400"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <div
                                    ...
                                    <template x-for="user in results" :key="user.id">
                                        ...
                                        <button
                                            ...
                                            <span
                                                x-text="user.email"
                                                class="text-zinc-400 text-xs"></span>
                                        </button>
                                ...
                                {{-- Usuário selecionado --}}
                                <div
                                    x-show="selectedUser.id"
                                    x-cloak
                                    class="mt-2 text-sm text-sky-400">
                                    Selecionado:
