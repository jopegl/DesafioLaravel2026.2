        ...
        <div class="flex-1 flex flex-col"
                            ...
                            <tr class="border-b border-gray-800/40 last:border-0 hover:bg-white/[0.02]">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center justify-end gap-3 text-cyan-400">
                                        <button @click='openView(@json($product))' title="Visualizar" class="hover:text-cyan-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                            </svg>
                                        </button>
                                        <button @click='openEdit(@json($product))' title="Editar" class="hover:text-cyan-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <div x-show="showView" x-cloak
                ...
                <div @click.outside="showView = false"
                    class="bg-[#1c1f2a] w-full max-w-md rounded-xl border border-gray-800 p-6 max-h-[90vh] overflow-y-auto"
                    x-show="selected">
                    <h3 class="text-white text-lg font-semibold text-center mb-5">Detalhes do produto</h3>
