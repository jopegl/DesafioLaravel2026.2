                ...
                <form method="GET" action="{{ route('sales.index') }}"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="date" id="start" name="start" value="{{ request('start') }}"
                            class="bg-[#1c1f2a] border border-gray-700 text-sm text-white rounded-lg px-3 py-2
                   ...
                   border border-cyan-500/50 transition-all duration-200">
                    ...
                    <a href="{{ route('sales.index') }}"
                        class="inline-flex items-center px-4 py-2 text-sm text-gray-400 hover:text-white
